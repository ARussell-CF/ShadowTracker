...
namespace ShadowTracker.Controllers
{
    public class TicketHistoriesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Property,OldValue,NewValue,Created,Description,TicketId,UserId")] TicketHistory ticketHistory)
        {
            ...
            ViewData["TicketId"] = new SelectList(_context.Tickets, "Id", "Title", ticketHistory.TicketId);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Property,OldValue,NewValue,Created,Description,TicketId,UserId")] TicketHistory ticketHistory)
        {
