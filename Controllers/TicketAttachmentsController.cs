...
namespace ShadowTracker.Controllers
{
    public class TicketAttachmentsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,TicketId,TicketTaskId,Created,Description,AttachmentData,AttachmentType,FileName,UserId")] TicketAttachment ticketAttachment)
        {
            ...
            ViewData["TicketId"] = new SelectList(_context.Tickets, "Id", "Title", ticketAttachment.TicketId);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,TicketId,TicketTaskId,Created,Description,AttachmentData,AttachmentType,FileName,UserId")] TicketAttachment ticketAttachment)
        {
