...
namespace ShadowTracker.Controllers
{
    public class TicketTasksController : Controller
    {
        ...
        {
            ViewData["TaskStatusId"] = new SelectList(_context.TicketStatuses, "Id", "Id");
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,Description,TicketId,TaskStatusId,TaskTypeId")] TicketTask ticketTask)
        {
            ...
            ViewData["TaskStatusId"] = new SelectList(_context.TicketStatuses, "Id", "Id", ticketTask.TaskStatusId);
            ViewData["TaskTypeId"] = new SelectList(_context.TicketTypes, "Id", "Id", ticketTask.TaskTypeId);
            ViewData["TicketId"] = new SelectList(_context.Tickets, "Id", "Title", ticketTask.TicketId);
            return View(ticketTask);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,Description,TicketId,TaskStatusId,TaskTypeId")] TicketTask ticketTask)
        {
            if (id != ticketTask.Id)
            {
                return NotFound();
